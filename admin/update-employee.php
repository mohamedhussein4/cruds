                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">تحديث قسم الموظفين</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">موظف</a></li>
                                <li><span>تحديث</span></li>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">بلد</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">نوع إجازتك</label>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">احدث تغيير</button>
