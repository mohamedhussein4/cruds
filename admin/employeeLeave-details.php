                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">تفاصيل الاجازات</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="dashboard.php">الصفحة الرئيسية</a></li>
                                <li><span>تفاصيل الاجازات</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>معلومات: </strong><?php echo htmlentities($error); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if($stats==1){
                                ?>
                                    <span style="color: green">موافقة</span>
                                    <?php } if($stats==2)  { ?>
                                ...
                                <tr>
                                <td ><b>تم تشغيل الإجراء الإداري: </b></td>
                                    <td><?php
                            ...
                            <tr>
                            <td colspan="12">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">ضبط العمل</button>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">ضبط العمل</h5>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-dismiss="modal">يغلق</button>
                                    <button type="submit" class="btn btn-success" name="update">يتقدم</button>
                                </div>
                                </div>
                            </div>
                            </div>
