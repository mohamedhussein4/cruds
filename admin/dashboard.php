                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>لوحة تحكم المشرف</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">أنواع الإجازات المتاحة</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">الموظفون المسجلون</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">الأقسام المتاحة</h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php include 'counters/dept-counter.php'?></h1>
                                        <span>إدارات الموظفين</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">التطبيق المعلق</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">طلب مرفوض</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">تطبيق الموافقة</h4>
							...
							<div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="trd-history-tabs">
                                        <ul class="nav" role="tablist">
                                            <li>
                                                <a class="active" data-toggle="tab" href="dashboard.php" role="tab">القائمة الأخيرة</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <select class="custome-select border-0 pr-3">
                                        <option selected>أخر 24 ساعة</option>
                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <tr>
                                                        <td>رقم التعريف</td>
                                                        <td>رقم تعريف الموظف</td>
                                                        <td width="120">الاسم بالكامل</td>
                                                        <td>نوع الإجازة</td>
                                                        <td>تم التطبيق</td>
                                        ...
                                        <tr>
                                            ...
                                            if($stats==1){
                                             ?>
                                                 <span style="color: green">موافقة <i class="fa fa-check-square-o"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">مرفوض <i class="fa fa-times"></i></span>
                                                 <?php } if($stats==0)  { ?>
                                            ...
                                            <td><a href="employeeLeave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="btn btn-secondary btn-sm">عرض التفاصيل</a></td>
                                            </tr>
                                                <?php $cnt++;} }?>
                                            </tbody>
                                                </table>
