...
<head>
    ...
    <title>Admin Panel - VCRUDS</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            ...
            <div class="logo" style="text-align: left;color: #fff;">
                <a href="dashboard.php"><h1 style="color:#fff;">VCRUDS</h1></a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">إضافة قسم الموظف</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">موظف</a></li>
                                <li><span>يضيف</span></li>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">المشرف <i class="fa fa-angle-down"></i></h4>
            ...
            <div class="main-content-inner">
                ...
                <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>معلومات: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            
                             </div><?php } 
                                 else if($msg){?><div class="alert alert-success alert-dismissible fade show"><strong>معلومات: </strong><?php echo htmlentities($msg); ?> 
                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                 </div><?php }?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">يرجى ملء النموذج لإضافة سجلات الموظفين</p>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">رقم تعريف الموظف</label>
                                            <input class="form-control" name="empcode" type="text" autocomplete="off" required id="empcode" onBlur="checkAvailabilityEmpid()">
                                        </div>
                                    

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">الاسم الأول</label>
                                            <input class="form-control" name="firstName"  type="text" required id="example-text-input">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">اسم العائلة</label>
                                            <input class="form-control" name="lastName" type="text" autocomplete="off" required id="example-text-input">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-email-input" class="col-form-label">بريد إلكتروني</label>
                                            <input class="form-control" name="email" type="email"  autocomplete="off" required id="example-email-input">
                                        </div>

                                        <div class="form-group">
                                            <label class="col-form-label">القسم المفضل</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">رقم الاتصال</label>
                                            <input class="form-control" name="mobileno" type="tel"  maxlength="10" autocomplete="off" required>
                                        </div>


                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">دولة</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">مدينة</label>
                                            <input class="form-control" name="city" type="text"   autocomplete="off" required>
                                        </div>

                                        <h4>تعيين كلمة مرور لتسجيل دخول الموظف</h4>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">تأكيد كلمة المرور</label>
                                            <input class="form-control" name="confirmpassword" type="password" autocomplete="off" required>
                                        </div>

                        

                                        <button class="btn btn-primary" name="add" id="update" type="submit" onclick="return valid();">اضف</button>
