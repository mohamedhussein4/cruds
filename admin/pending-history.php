                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">الاجازات المعلقة</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="dashboard.php">الصفحة الرئيسية</a></li>
                                <li><span>قائمة معلقة</span></li>
                                    ...
                                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->PostingDate);?></td>
                                                ...
                                                if($stats==1){
                                             ?>
                                                 <span style="color: green">موافقة <i class="fa fa-thumbs-o-up"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">مرفوض <i class="fa fa-thumbs-o-down"></i></span>
                                                 <?php } if($stats==0)  { ?>
